...
public class DispatcherServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest request,
        ...
        switch (uri) {
            ...
            case "/mvc/article/delectArticle" -> articleController.deleteArticle(request, response);
            case "/mvc/article/articleDelect" -> articleController.articleDelect(request, response);
